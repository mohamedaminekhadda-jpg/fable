...
import { vignette } from './vignettes.js?v=mu601i05';
import { BRAND, marque, blocMarque } from './brand.js?v=mu601i05';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu601i05';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu601i05');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
