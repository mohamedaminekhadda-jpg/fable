...
import { vignette } from './vignettes.js?v=mu7g947a';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7g947a';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7g947a';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7g947a');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
