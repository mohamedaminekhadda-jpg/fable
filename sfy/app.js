...
import { vignette } from './vignettes.js?v=mu5wau32';
import { BRAND, marque, blocMarque } from './brand.js?v=mu5wau32';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu5wau32';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu5wau32');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
