...
import { vignette } from './vignettes.js?v=mu6gxlg8';
import { BRAND, marque, blocMarque } from './brand.js?v=mu6gxlg8';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu6gxlg8';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu6gxlg8');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
