...
import { vignette } from './vignettes.js?v=mu80nodt';
import { BRAND, marque, blocMarque } from './brand.js?v=mu80nodt';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu80nodt';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu80nodt');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
