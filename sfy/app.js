...
import { vignette } from './vignettes.js?v=mu5x0ldz';
import { BRAND, marque, blocMarque } from './brand.js?v=mu5x0ldz';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu5x0ldz';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu5x0ldz');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
