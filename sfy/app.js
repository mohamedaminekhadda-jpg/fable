...
import { vignette } from './vignettes.js?v=mu78k1hy';
import { BRAND, marque, blocMarque } from './brand.js?v=mu78k1hy';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu78k1hy';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu78k1hy');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
