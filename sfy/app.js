...
import { vignette } from './vignettes.js?v=mu7frggz';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7frggz';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7frggz';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7frggz');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
