...
import { vignette } from './vignettes.js?v=mu5389dm';
import { BRAND, marque, blocMarque } from './brand.js?v=mu5389dm';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu5389dm';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu5389dm');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
