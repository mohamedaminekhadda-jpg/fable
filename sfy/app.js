...
import { vignette } from './vignettes.js?v=mud91fpe';
import { BRAND, marque, blocMarque } from './brand.js?v=mud91fpe';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mud91fpe';
...
async function load() {
  const r = await fetch('catalogue.json?v=mud91fpe');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
