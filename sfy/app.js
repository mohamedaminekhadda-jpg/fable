...
import { vignette } from './vignettes.js?v=mubmkrja';
import { BRAND, marque, blocMarque } from './brand.js?v=mubmkrja';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mubmkrja';
...
async function load() {
  const r = await fetch('catalogue.json?v=mubmkrja');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
