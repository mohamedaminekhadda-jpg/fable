...
import { vignette } from './vignettes.js?v=mubkbmo2';
import { BRAND, marque, blocMarque } from './brand.js?v=mubkbmo2';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mubkbmo2';
...
async function load() {
  const r = await fetch('catalogue.json?v=mubkbmo2');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
