...
import { vignette } from './vignettes.js?v=mu7tpwbt';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7tpwbt';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7tpwbt';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7tpwbt');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
