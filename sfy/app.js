...
import { vignette } from './vignettes.js?v=mu6jyy8u';
import { BRAND, marque, blocMarque } from './brand.js?v=mu6jyy8u';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu6jyy8u';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu6jyy8u');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
