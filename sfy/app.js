...
import { vignette } from './vignettes.js?v=mu5tc0ak';
import { BRAND, marque, blocMarque } from './brand.js?v=mu5tc0ak';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu5tc0ak';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu5tc0ak');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
