...
import { vignette } from './vignettes.js?v=mu7zipbs';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7zipbs';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7zipbs';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7zipbs');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
