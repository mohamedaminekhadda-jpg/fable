...
import { vignette } from './vignettes.js?v=mu7fl9i5';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7fl9i5';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7fl9i5';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7fl9i5');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
