...
import { vignette } from './vignettes.js?v=muavndct';
import { BRAND, marque, blocMarque } from './brand.js?v=muavndct';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=muavndct';
...
async function load() {
  const r = await fetch('catalogue.json?v=muavndct');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
