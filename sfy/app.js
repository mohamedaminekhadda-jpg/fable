...
import { vignette } from './vignettes.js?v=mudb2j1o';
import { BRAND, marque, blocMarque } from './brand.js?v=mudb2j1o';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mudb2j1o';
...
async function load() {
  const r = await fetch('catalogue.json?v=mudb2j1o');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
