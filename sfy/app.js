...
import { vignette } from './vignettes.js?v=mu5xc46i';
import { BRAND, marque, blocMarque } from './brand.js?v=mu5xc46i';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu5xc46i';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu5xc46i');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
