...
import { vignette } from './vignettes.js?v=mu6idrdg';
import { BRAND, marque, blocMarque } from './brand.js?v=mu6idrdg';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu6idrdg';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu6idrdg');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
