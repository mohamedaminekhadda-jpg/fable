...
import { vignette } from './vignettes.js?v=mud89d1w';
import { BRAND, marque, blocMarque } from './brand.js?v=mud89d1w';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mud89d1w';
...
async function load() {
  const r = await fetch('catalogue.json?v=mud89d1w');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
