...
import { vignette } from './vignettes.js?v=mu7j3qbq';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7j3qbq';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7j3qbq';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7j3qbq');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
