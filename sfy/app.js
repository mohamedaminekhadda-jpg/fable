...
import { vignette } from './vignettes.js?v=mu536jxn';
import { BRAND, marque, blocMarque } from './brand.js?v=mu536jxn';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu536jxn';
