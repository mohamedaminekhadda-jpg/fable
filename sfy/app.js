...
import { vignette } from './vignettes.js?v=mudm88x6';
import { BRAND, marque, blocMarque } from './brand.js?v=mudm88x6';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mudm88x6';
...
async function load() {
  const r = await fetch('catalogue.json?v=mudm88x6');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
