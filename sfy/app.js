...
import { vignette } from './vignettes.js?v=mud77bub';
import { BRAND, marque, blocMarque } from './brand.js?v=mud77bub';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mud77bub';
...
async function load() {
  const r = await fetch('catalogue.json?v=mud77bub');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
