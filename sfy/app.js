...
import { vignette } from './vignettes.js?v=muejommc';
import { BRAND, marque, blocMarque } from './brand.js?v=muejommc';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=muejommc';
import { miroirHTML, animerMiroir } from './miroir.js?v=muejommc';
...
async function load() {
  const r = await fetch('catalogue.json?v=muejommc');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
