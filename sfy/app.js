...
import { vignette } from './vignettes.js?v=mudne5aq';
import { BRAND, marque, blocMarque } from './brand.js?v=mudne5aq';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mudne5aq';
...
async function load() {
  const r = await fetch('catalogue.json?v=mudne5aq');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
