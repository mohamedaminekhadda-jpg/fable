...
import { vignette } from './vignettes.js?v=mubolwgx';
import { BRAND, marque, blocMarque } from './brand.js?v=mubolwgx';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mubolwgx';
...
async function load() {
  const r = await fetch('catalogue.json?v=mubolwgx');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
