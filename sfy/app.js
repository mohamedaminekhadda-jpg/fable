...
import { vignette } from './vignettes.js?v=muatcpjc';
import { BRAND, marque, blocMarque } from './brand.js?v=muatcpjc';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=muatcpjc';
...
async function load() {
  const r = await fetch('catalogue.json?v=muatcpjc');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
