...
import { vignette } from './vignettes.js?v=mubo2eej';
import { BRAND, marque, blocMarque } from './brand.js?v=mubo2eej';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mubo2eej';
...
async function load() {
  const r = await fetch('catalogue.json?v=mubo2eej');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
