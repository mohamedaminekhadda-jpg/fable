...
import { vignette } from './vignettes.js?v=mu7dohz9';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7dohz9';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7dohz9';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7dohz9');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
