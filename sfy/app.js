...
import { vignette } from './vignettes.js?v=mu6jpsqr';
import { BRAND, marque, blocMarque } from './brand.js?v=mu6jpsqr';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu6jpsqr';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu6jpsqr');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
