...
import { vignette } from './vignettes.js?v=mu7ix6p8';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7ix6p8';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7ix6p8';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7ix6p8');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
