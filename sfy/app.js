...
import { vignette } from './vignettes.js?v=mu5vhxe3';
import { BRAND, marque, blocMarque } from './brand.js?v=mu5vhxe3';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu5vhxe3';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu5vhxe3');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
