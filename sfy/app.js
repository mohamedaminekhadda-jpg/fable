...
import { vignette } from './vignettes.js?v=mu7d97f6';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7d97f6';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7d97f6';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7d97f6');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
