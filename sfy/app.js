...
import { vignette } from './vignettes.js?v=mu60757l';
import { BRAND, marque, blocMarque } from './brand.js?v=mu60757l';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu60757l';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu60757l');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
