...
import { vignette } from './vignettes.js?v=mu7ujvqv';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7ujvqv';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7ujvqv';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7ujvqv');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
