...
import { vignette } from './vignettes.js?v=mudmn8h3';
import { BRAND, marque, blocMarque } from './brand.js?v=mudmn8h3';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mudmn8h3';
...
async function load() {
  const r = await fetch('catalogue.json?v=mudmn8h3');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
