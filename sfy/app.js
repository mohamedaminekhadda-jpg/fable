...
import { vignette } from './vignettes.js?v=mu84121j';
import { BRAND, marque, blocMarque } from './brand.js?v=mu84121j';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu84121j';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu84121j');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
