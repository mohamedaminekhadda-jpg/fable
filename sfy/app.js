...
import { vignette } from './vignettes.js?v=mu6di5pz';
import { BRAND, marque, blocMarque } from './brand.js?v=mu6di5pz';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu6di5pz';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu6di5pz');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
