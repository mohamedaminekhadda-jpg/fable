...
import { vignette } from './vignettes.js?v=muatkgg7';
import { BRAND, marque, blocMarque } from './brand.js?v=muatkgg7';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=muatkgg7';
...
async function load() {
  const r = await fetch('catalogue.json?v=muatkgg7');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
