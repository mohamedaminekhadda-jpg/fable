...
import { vignette } from './vignettes.js?v=mudbqpcu';
import { BRAND, marque, blocMarque } from './brand.js?v=mudbqpcu';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mudbqpcu';
...
async function load() {
  const r = await fetch('catalogue.json?v=mudbqpcu');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
