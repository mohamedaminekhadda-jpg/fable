...
import { vignette } from './vignettes.js?v=mudckaid';
import { BRAND, marque, blocMarque } from './brand.js?v=mudckaid';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mudckaid';
...
async function load() {
  const r = await fetch('catalogue.json?v=mudckaid');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
