...
import { vignette } from './vignettes.js?v=mu7bhvdd';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7bhvdd';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7bhvdd';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7bhvdd');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
