...
import { vignette } from './vignettes.js?v=mu7u7lqq';
import { BRAND, marque, blocMarque } from './brand.js?v=mu7u7lqq';
import { LANG, T, champ, poserSelecteur } from './langue.js?v=mu7u7lqq';
...
async function load() {
  const r = await fetch('catalogue.json?v=mu7u7lqq');
  DATA = await r.json();
  cycleDuFoyer();
  render();
}
